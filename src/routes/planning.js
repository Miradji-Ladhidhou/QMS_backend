...
// GET /api/planning — agrège CAPA/documents/formations/tâches/audits en une liste
// chronologique unique, avec le même filtrage par rôle et par service que
// /api/dashboard/stats :
...
//   les audits qu'il mène) — jamais de documents (pas de porteur individuel) ni de vue
//   tenant/service
router.get('/', async (req, res) => {
  ...
  if (req.userRole === 'member') {
    ...
    items = [...capaItems, ...trainingItems, ...taskItems, ...auditItems];
  } else {
    ...
    items = [...capaItems, ...documentItems, ...trainingItems, ...taskItems, ...auditItems];
  }
