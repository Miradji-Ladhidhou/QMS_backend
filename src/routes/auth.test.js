...
// L'inscription publique a été retirée (voir superAdmin.js#POST /tenants, seul point d'entrée
// restant pour créer un compte, réservé au super admin) — verrouille ce comportement.
describe('POST /api/auth/register — route retirée', () => {
  it("n'existe plus (404), la création de compte passe par POST /super-admin/tenants", async () => {
