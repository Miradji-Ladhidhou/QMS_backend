...
import pdcaRoutes from './routes/pdca.js';
...
import qualityObjectivesRoutes from './routes/qualityObjectives.js';
...
app.use('/api/quality-objectives', qualityObjectivesRoutes);
